...
class MafiaGameStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PublishMessage = channel.unary_unary(
                '/mafia.MafiaGame/PublishMessage',
                request_serializer=mafia__pb2.PublishMessageRequest.SerializeToString,
                response_deserializer=mafia__pb2.PublishMessageResponse.FromString,
                )
...
def add_MafiaGameServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PublishMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mafia__pb2.PublishMessageRequest.FromString,
                    response_serializer=mafia__pb2.PublishMessageResponse.SerializeToString,
            ),
    }
...
class MafiaGame(object):
    ...
    def PublishMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mafia.MafiaGame/PublishMessage',
            mafia__pb2.PublishMessageRequest.SerializeToString,
            mafia__pb2.PublishMessageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
